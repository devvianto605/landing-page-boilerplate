const booleanError = 'It is better if your prop ({{ propName }}) matches this pattern: ({{ pattern }})';
...
module.exports = {
  ...
  'react/boolean-prop-naming': ['error', { rule: '^(is|has)[A-Z]([A-Za-z0-9]?)+', message: booleanError }],
